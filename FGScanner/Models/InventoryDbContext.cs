...
public partial class InventoryDbContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<TransactionHistory>(entity =>
        {
            ...
            entity.ToTable("transaction_history", tb => tb.HasTrigger("trg_UpdateInventory")).HasOne( t => t.ReturnTable).WithMany(r => r.TransactionHistories).HasForeignKey(t => t.ControlNumber).HasPrincipalKey(t => t.TransactionId);
            entity.ToTable("transaction_history", tb => tb.HasTrigger("trg_UpdateInventory")).HasOne(t => t.ShipmentTable).WithMany(r => r.TransactionHistories).HasForeignKey(t => t.ControlNumber).HasPrincipalKey(t => t.TransactionId);
