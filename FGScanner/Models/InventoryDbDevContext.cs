...
public partial class InventoryDbDevContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<TransactionHistory>(entity =>
        {
            ...
            entity.HasOne(d => d.ControlNumberNavigation).WithMany(p => p.TransactionHistories)
                .HasForeignKey(d => d.ControlNumber)
                .HasConstraintName("FK_transaction_return");

            entity.HasOne(d => d.ControlNumber1).WithMany(p => p.TransactionHistories)
                .HasForeignKey(d => d.ControlNumber)
